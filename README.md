...
|---|---|
| 🪟 Windows | [DownMusic.Setup.0.1.3.exe](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic.Setup.0.1.3.exe) |
| 🍎 macOS Apple Silicon | [DownMusic-0.1.3-arm64.dmg](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic-0.1.3-arm64.dmg) |
| 🍎 macOS Intel | [DownMusic-0.1.3-x64.dmg](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic-0.1.3-x64.dmg) |
| 🐧 Linux | [DownMusic-0.1.3.AppImage](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic-0.1.3.AppImage) |

> Os links diretos apontam para a `v0.1.3`. Para sempre pegar a mais nova, use a
...
1. Baixe o **[DownMusic.Setup.0.1.3.exe](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic.Setup.0.1.3.exe)**.
...
1. Baixe o **[DownMusic-0.1.3-arm64.dmg](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic-0.1.3-arm64.dmg)**
   (Apple Silicon) ou
   **[DownMusic-0.1.3-x64.dmg](https://github.com/kadufarah1979/DownMusic/releases/download/v0.1.3/DownMusic-0.1.3-x64.dmg)**
